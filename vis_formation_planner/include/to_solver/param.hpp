...
namespace SwarmPlanning{
    ...
    bool Param::setROSParam(const ros::NodeHandle &nh) {
        ...
        nh.param<double>("world/x_min", world_x_min, -100);
        nh.param<double>("world/y_min", world_y_min, -100);
        nh.param<double>("world/z_min", world_z_min, 0);
        nh.param<double>("world/x_max", world_x_max, 100);
        nh.param<double>("world/y_max", world_y_max, 100);
        ...
        nh.param<double>("plan/time_step", time_step, 1.0);
