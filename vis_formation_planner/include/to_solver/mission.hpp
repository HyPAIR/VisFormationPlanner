#pragma once
#include <to_solver/rapidjson/document.h>
#include <to_solver/rapidjson/istreamwrapper.h>
#include <fstream>
#include <ros/ros.h>
#include <string>
#include <random>
...
namespace SwarmPlanning {
    ...
    public:
        ...
        std::vector<double> quad_size, quad_speed, quad_type;
    ...
    bool Mission::setMission(const ros::NodeHandle &nh) {
        ...
        for(SizeType qi = 0; qi < agents.Size(); qi++){
            ...
            // type
            quad_type[qi] = agents[qi].GetObject()["type"].GetDouble();
        }
