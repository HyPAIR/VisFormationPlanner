...
int main(int argc, char* argv[])
{
    ...
    // 将YAML文档写入文件
    std::ofstream outFileHyperplane("/home/weijian/Heterogeneous_formation/src/vis_formation_planner/src/decomp_util/hyperplane.yaml");
    ...
    // 将YAML文档写入文件
    std::ofstream outFileVertice("/home/weijian/Heterogeneous_formation/src/vis_formation_planner/src/decomp_util/vertices.yaml");
